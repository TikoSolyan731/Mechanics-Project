...
import com.aua.mechanics.systems.BallInsideCircleSystem;

public class Task1Solver {
    public static void main(String[] args) {
        var system = new BallInsideCircleSystem(1, 1);
        double delta = 0.1;

        System.out.println("initial position = " + system.getCurrentPosition());
